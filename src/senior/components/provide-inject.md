...
:::info
Provide/inject is useful for creating tightly coupled components that is components that must always be used together.
:::
...
App-level provides are available to all components rendered in the app. This is especially useful when writing [plugins](/study/intermediate/plugins), as plugins typically wouldn't be able to provide values using components.
...
See also: [Typing Provide / Inject](/senior/typescript/composition-api#typing-provide-inject) <sup class="vt-badge ts" />
